...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
       ...
       it('URL in each feeds is defined', function(){
       ...
       it('Name in each feed is defined', function(){
         allFeeds.forEach(function(feed){
       ...
       */
        ...
        it('is hidden to start', function(){
           var docBody = document.body;
            expect(docBody).toHaveClass('menu-hidden');
        });
        ...
        */
        ...
        it('comes when you click the hamburger and goes away when you click it again', function(){
          ...
          var menuVisible = [];
          var itWorks = false;
          if (docBody.className === 'menu-hidden'){
            menuVisible.push('true');
          } else {menuVisible.push('false');};
          hamburger.click();
          if (docBody.className === 'menu-hidden'){
            menuVisible.push('true');
          } else {menuVisible.push('false');};
          ...
          if (menuVisible[0] != menuVisible[1] && menuVisible[1] != menuVisible[2]){
            itWorks = true;
          }
